// i think i'll just keep these tokens here , putting them on an env file is not necessarily
...
const firebaseConfig = {
  ...
  databaseURL:
    "https://menudb-96d7a-default-rtdb.asia-southeast1.firebasedatabase.app/",
